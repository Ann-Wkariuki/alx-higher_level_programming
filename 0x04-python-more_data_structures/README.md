...
12-roman_to_int.py: Technical interview preparation Create a function def roman_to_int(roman_string) that converts a Roman numeral to an integer.
...
guillaume@ubuntu:dict = update_dictionary(a_dictionary, 'language', "Python")
...
ids: [1, 2, 3]
track: Low
guillaume@ubuntu:~/0x04$ ~/0x04$ ./5-main.py
Number of keys: 3
guillaume@ubuntu:~/0x04$ 
